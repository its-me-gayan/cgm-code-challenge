 ...
 */
public class QuestionMngHelper {

    private static QuestionMngHelper questionMngHelper;
    private QuestionMngHelper() {
    }

    public static QuestionMngHelper getInstance() {
        return Objects.isNull(questionMngHelper) ? new QuestionMngHelper() : questionMngHelper;
    }
